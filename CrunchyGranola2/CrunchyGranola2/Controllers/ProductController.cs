...
namespace CrunchyGranola2.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,Price,UpcCode,Description,Quantity,LeadTime,DepartmentID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,Price,UpcCode,Description,Quantity,LeadTime,DepartmentID")] Product product)
        {
            if (ModelState.IsValid)
            {
